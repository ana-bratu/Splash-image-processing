# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 16:30:23 2024
...
for s in StackList:
    ...
    line_coordinates = []
    extract_line_coord(cv2.normalize(TopStack[10], dst=None, alpha=0, beta=65535, norm_type=cv2.NORM_MINMAX))
    ...
    side_velocity = extract_velocity(line_coordinates)
    print("Side Jet velocity", side_velocity, "mm/s")

    


    impact_v.append(side_velocity)
    
    SD.loc[s,'Side Jet velocity'] = side_velocity
